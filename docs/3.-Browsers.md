...
If you need to support IE11 or Edge you will also need to install a text-encoder as eosjs Signing is dependent on the TextEncoder which IE11 and Edge do not provide.  Pass the TextEncoder and TextDecoder to the API constructor as demonstrated in the [ES 2015 example](#node-es-2015).  Refer to the documentation here https://developer.mozilla.org/en-US/docs/Web/API/TextEncoder to determine the best way to include it in your project.
